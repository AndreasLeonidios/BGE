...
public class BaseDeDatos {
	...
	public void crearTablas() throws SQLException {
		...
		statement
				.executeUpdate("CREATE TABLE IF NOT EXISTS USUARIOS(NOMBRE VARCHAR(20)," + " CONTRASENYA VARCHAR(20))");

		statement.executeUpdate(
				"CREATE TABLE IF NOT EXISTS HEROES(nombre varchar(20), nombreHeroe VARCHAR(20) not null primary key, puntuacion number(3), velocidad number(2), ataque number(2), vida number(2))");
	...
	public void anyadirHeroe(String nombreUsuario, String nombreHeroe, int puntuacion, int velocidad, int ataque,
			int vida) throws SQLException {

		statement.executeUpdate("insert into HEROES values('" + nombreUsuario + "', '" + nombreHeroe + "', "
				+ puntuacion + ", " + velocidad + ", " + ataque + ", " + vida + ")");
	}
